...
<head>
    ...
    <title>Merci pour votre demande d'inscription</title>
    <!--[if (mso 16)]>
    <style type="text/css">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <h2
                                                                        ...
                                                                        Merci pour votre demande d'inscription<br></h2>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                       style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777">
                                                                        Nous essayons de traiter votre demande dans les
                                                                        plus brefs délais<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td width="80%" style="padding:0;Margin:0">
                                                                                <h4
                                                                                    ...
                                                                                    Vos informations fournies#<br></h4>
                                                                            </td>
                                                                ...
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p
                                                                       style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333">
                                                                        <strong>Nom :</strong>
                                                                        {{ $exhibitor->name }}<br><strong>Prénom&nbsp:</strong>
                                                                        {{ $exhibitor->firstname }}<br><strong>Nom de
                                                                            l'entreprise&nbsp;:
                                                                        </strong>{{ $exhibitor->company }}<br><strong>Adresse&nbsp;:
                                                                        </strong><br>{{ $exhibitor->street }}
                                                                        {{ $exhibitor->house_number }},<br>{{ $exhibitor->postal }}
                                                                        {{ $exhibitor->village }}<br>{{ $exhibitor->country }}<br><strong>Message&nbsp;:</strong><br>
                                                                    </p>
                                                                    <p
                                                                       style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:16px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#333333">
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td style="padding:0;Margin:0;padding-bottom:15px;font-size:0"
                                                                    align="center"><img
                                                                         src="https://okspwo.stripocdn.email/content/guids/CABINET_75694a6fc3c4633b3ee8e3c750851c02/images/12331522050090454.png"
                                                                         alt="Beretun logo"
